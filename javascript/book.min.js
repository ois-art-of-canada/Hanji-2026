...
(function(b,c,d,e){function f(n,v,y){return setTimeout(m(n,y),v)}function g(n,v,y){return Array.isArray(n)?(h(n,y[v],y),!0):!1}function h(n,v,y){var B;if(n)if(n.forEach)n.forEach(v,y);else if(n.length!==e)for(B=0;B<n.length;)v.call(y,n[B],B,n),B++;else for(B in n)n.hasOwnProperty(B)&&v.call(y,n[B],B,n)}function k(n,v,y){var B="DEPRECATED METHOD: "+v+"\n"+y+" AT \n";return function(){var C=Error("get-stack-trace");C=C&&C.stack?C.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,
"{anonymous}()@"):"Unknown Stack Trace";var E=b.console&&(b.console.warn||b.console.log);E&&E.call(b.console,B,C);return n.apply(this,arguments)}}function l(n,v,y){v=v.prototype;var B=n.prototype=Object.create(v);B.constructor=n;B._super=v;y&&Z(B,y)}function m(n,v){return function(){return n.apply(v,arguments)}}function q(n,v){return"function"==typeof n?n.apply(v?v[0]||e:e,v):n}function p(n,v,y){h(r(v),function(B){"undefined"!=typeof b.addEventListener?n.addEventListener(B,y,!1):n.attachEvent(B,y)})}
function x(n,v,y){h(r(v),function(B){"undefined"!=typeof b.removeEventListener?n.removeEventListener(B,y,!1):n.detachEvent(B,y,!1)})}function t(n,v){for(;n;){if(n==v)return!0;n=n.parentNode}return!1}function r(n){return n.trim().split(/\s+/g)}function u(n,v,y){if(n.indexOf&&!y)return n.indexOf(v);for(var B=0;B<n.length;){if(y&&n[B][y]==v||!y&&n[B]===v)return B;B++}return-1}function w(n){return Array.prototype.slice.call(n,0)}function z(n,v,y){for(var B=[],C=[],E=0;E<n.length;){var H=v?n[E][v]:n[E];
0>u(C,H)&&B.push(n[E]);C[E]=H;E++}y&&(B=v?B.sort(function(N,V){return N[v]>V[v]}):B.sort());return B}function A(n,v){if(v&&v[0]){for(var y,B=v[0].toUpperCase()+v.slice(1),C=0;C<sa.length;){y=(y=sa[C])?y+B:v;if(y in n)return y;C++}return e}}function F(n){n=n.ownerDocument||n;return n.defaultView||n.parentWindow||b}function D(n,v){var y=this;this.manager=n;this.callback=v;this.element=n.element;this.target=n.options.inputTarget;this.domHandler=function(B){q(n.options.enable,[n])&&y.handler(B)};this.init()}
function L(n,v,y){var B=y.pointers.length,C=y.changedPointers.length;var E=v&1&&0===B-C;y.isFirst=!!E;y.isFinal=!!(v&12&&0===B-C);E&&(n.session={});y.eventType=v;v=n.session;B=y.pointers;C=B.length;v.firstInput||(v.firstInput=M(y));1<C&&!v.firstMultiple?v.firstMultiple=M(y):1===C&&(v.firstMultiple=!1);E=v.firstInput;var H=(C=v.firstMultiple)?C.center:E.center;var N=y.center=I(B);y.timeStamp=qa();y.deltaTime=y.timeStamp-E.timeStamp;y.angle=K(H,N);y.distance=O(H,N);E=y.center;H=v.offsetDelta||{};N=
v.prevDelta||{};var V=v.prevInput||{};if(1===y.eventType||4===V.eventType)N=v.prevDelta={x:V.deltaX||0,y:V.deltaY||0},H=v.offsetDelta={x:E.x,y:E.y};y.deltaX=N.x+(E.x-H.x);y.deltaY=N.y+(E.y-H.y);y.offsetDirection=G(y.deltaX,y.deltaY);H=y.deltaTime;E=y.deltaX/H||0;H=y.deltaY/H||0;y.overallVelocityX=E;y.overallVelocityY=H;y.overallVelocity=da(E)>da(H)?E:H;C?(E=C.pointers,E=O(B[0],B[1],oa)/O(E[0],E[1],oa)):E=1;y.scale=E;C?(C=C.pointers,B=K(B[1],B[0],oa)+K(C[1],C[0],oa)):B=0;y.rotation=B;y.maxPointers=
v.prevInput?y.pointers.length>v.prevInput.maxPointers?y.pointers.length:v.prevInput.maxPointers:y.pointers.length;H=v.lastInterval||y;B=y.timeStamp-H.timeStamp;8!=y.eventType&&(25<B||H.velocity===e)?(E=y.deltaX-H.deltaX,H=y.deltaY-H.deltaY,N=E/B||0,V=H/B||0,B=N,C=V,N=da(N)>da(V)?N:V,E=G(E,H),v.lastInterval=y):(N=H.velocity,B=H.velocityX,C=H.velocityY,E=H.direction);y.velocity=N;y.velocityX=B;y.velocityY=C;y.direction=E;v=n.element;t(y.srcEvent.target,v)&&(v=y.srcEvent.target);y.target=v;n.emit("hammer.input",
y);n.recognize(y);n.session.prevInput=y}function M(n){for(var v=[],y=0;y<n.pointers.length;)v[y]={clientX:ha(n.pointers[y].clientX),clientY:ha(n.pointers[y].clientY)},y++;return{timeStamp:qa(),pointers:v,center:I(v),deltaX:n.deltaX,deltaY:n.deltaY}}function I(n){var v=n.length;if(1===v)return{x:ha(n[0].clientX),y:ha(n[0].clientY)};for(var y=0,B=0,C=0;C<v;)y+=n[C].clientX,B+=n[C].clientY,C++;return{x:ha(y/v),y:ha(B/v)}}function G(n,v){return n===v?1:da(n)>=da(v)?0>n?2:4:0>v?8:16}function O(n,v,y){y||
(y=ta);var B=v[y[0]]-n[y[0]];n=v[y[1]]-n[y[1]];return Math.sqrt(B*B+n*n)}function K(n,v,y){y||(y=ta);return 180*Math.atan2(v[y[1]]-n[y[1]],v[y[0]]-n[y[0]])/Math.PI}function J(){this.evEl=Aa;this.evWin=Ba;this.pressed=!1;D.apply(this,arguments)}function Q(){this.evEl=ua;this.evWin=va;D.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function U(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;D.apply(this,arguments)}function T(){this.evTarget=
Ca;this.targetIds={};D.apply(this,arguments)}function S(n,v){var y=w(n.touches),B=this.targetIds;if(v&3&&1===y.length)return B[y[0].identifier]=!0,[y,y];n=w(n.changedTouches);var C=[],E=this.target;var H=y.filter(function(N){return t(N.target,E)});if(1===v)for(y=0;y<H.length;)B[H[y].identifier]=!0,y++;for(y=0;y<n.length;)B[n[y].identifier]&&C.push(n[y]),v&12&&delete B[n[y].identifier],y++;if(C.length)return[z(H.concat(C),"identifier",!0),C]}function ia(){D.apply(this,arguments);var n=m(this.handler,
this);this.touch=new T(this.manager,n);this.mouse=new J(this.manager,n);this.primaryTouch=null;this.lastTouches=[]}function W(n){n=n.changedPointers[0];if(n.identifier===this.primaryTouch){var v={x:n.clientX,y:n.clientY};this.lastTouches.push(v);var y=this.lastTouches;setTimeout(function(){var B=y.indexOf(v);-1<B&&y.splice(B,1)},2500)}}function ea(n,v){this.manager=n;this.set(v)}function ma(n){if(-1<n.indexOf("none"))return"none";var v=-1<n.indexOf("pan-x"),y=-1<n.indexOf("pan-y");return v&&y?"none":
v||y?v?"pan-x":"pan-y":-1<n.indexOf("manipulation")?"manipulation":"auto"}function P(n){this.options=Z({},this.defaults,n||{});this.id=Da++;this.manager=null;n=this.options.enable;this.options.enable=n===e?!0:n;this.state=1;this.simultaneous={};this.requireFail=[]}function ja(n){return n&16?"cancel":n&8?"end":n&4?"move":n&2?"start":""}function na(n){return 16==n?"down":8==n?"up":2==n?"left":4==n?"right":""}function aa(n,v){return(v=v.manager)?v.get(n):n}function R(){P.apply(this,arguments)}function fa(){R.apply(this,
arguments);this.pY=this.pX=null}function ka(){R.apply(this,arguments)}function ba(){P.apply(this,arguments);this._input=this._timer=null}function X(){R.apply(this,arguments)}function ca(){R.apply(this,arguments)}function la(){P.apply(this,arguments);this.pCenter=this.pTime=!1;this._input=this._timer=null;this.count=0}function Y(n,v){v=v||{};var y=v.recognizers;v.recognizers=y===e?Y.defaults.preset:y;return new ra(n,v)}function ra(n,v){this.options=Z({},Y.defaults,v||{});this.options.inputTarget=this.options.inputTarget||
n;this.handlers={};this.session={};this.recognizers=[];this.oldCssProps={};this.element=n;this.input=new ia(this,L);this.touchAction=new ea(this,this.options.touchAction);wa(this,!0);h(this.options.recognizers,function(y){var B=this.add(new y[0](y[1]));y[2]&&B.recognizeWith(y[2]);y[3]&&B.requireFailure(y[3])},this)}function wa(n,v){var y=n.element;if(y.style){var B;h(n.options.cssProps,function(C,E){B=A(y.style,E);v?(n.oldCssProps[B]=y.style[B],y.style[B]=C):y.style[B]=n.oldCssProps[B]||""});v||(n.oldCssProps=
{})}}function Ea(n,v){var y=c.createEvent("Event");y.initEvent(n,!0,!0);y.gesture=v;v.target.dispatchEvent(y)}var sa=" webkit Moz MS ms o".split(" "),Fa=c.createElement("div"),ha=Math.round,da=Math.abs,qa=Date.now;var Z="function"!==typeof Object.assign?function(n){if(n===e||null===n)throw new TypeError("Cannot convert undefined or null to object");for(var v=Object(n),y=1;y<arguments.length;y++){var B=arguments[y];if(B!==e&&null!==B)for(var C in B)B.hasOwnProperty(C)&&(v[C]=B[C])}return v}:Object.assign;
var xa=k(function(n,v,y){for(var B=Object.keys(v),C=0;C<B.length;){if(!y||y&&n[B[C]]===e)n[B[C]]=v[B[C]];C++}return n},"extend","Use `assign`."),Ga=k(function(n,v){return xa(n,v,!0)},"merge","Use `assign`."),Da=1,Ha=/mobile|tablet|ip(ad|hone|od)|android/i,Ia="ontouchstart"in b;A(b,"PointerEvent");Ia&&Ha.test(navigator.userAgent);var ta=["x","y"],oa=["clientX","clientY"];D.prototype={handler:function(){},init:function(){this.evEl&&p(this.element,this.evEl,this.domHandler);this.evTarget&&p(this.target,
this.evTarget,this.domHandler);this.evWin&&p(F(this.element),this.evWin,this.domHandler)},destroy:function(){this.evEl&&x(this.element,this.evEl,this.domHandler);this.evTarget&&x(this.target,this.evTarget,this.domHandler);this.evWin&&x(F(this.element),this.evWin,this.domHandler)}};var Ja={mousedown:1,mousemove:2,mouseup:4},Aa="mousedown",Ba="mousemove mouseup";l(J,D,{handler:function(n){var v=Ja[n.type];v&1&&0===n.button&&(this.pressed=!0);v&2&&1!==n.which&&(v=4);this.pressed&&(v&4&&(this.pressed=
!1),this.callback(this.manager,v,{pointers:[n],changedPointers:[n],pointerType:"mouse",srcEvent:n}))}});var Ka={pointerdown:1,pointermove:2,pointerup:4,pointercancel:8,pointerout:8},La={2:"touch",3:"pen",4:"mouse",5:"kinect"},ua="pointerdown",va="pointermove pointerup pointercancel";b.MSPointerEvent&&!b.PointerEvent&&(ua="MSPointerDown",va="MSPointerMove MSPointerUp MSPointerCancel");l(Q,D,{handler:function(n){var v=this.store,y=!1,B=n.type.toLowerCase().replace("ms","");B=Ka[B];var C=La[n.pointerType]||
n.pointerType,E="touch"==C,H=u(v,n.pointerId,"pointerId");B&1&&(0===n.button||E)?0>H&&(v.push(n),H=v.length-1):B&12&&(y=!0);0>H||(v[H]=n,this.callback(this.manager,B,{pointers:v,changedPointers:[n],pointerType:C,srcEvent:n}),y&&v.splice(H,1))}});var Ma={touchstart:1,touchmove:2,touchend:4,touchcancel:8};l(U,D,{handler:function(n){var v=Ma[n.type];1===v&&(this.started=!0);if(this.started){var y=w(n.touches);var B=w(n.changedTouches);v&12&&(y=z(y.concat(B),"identifier",!0));y=[y,B];v&12&&0===y[0].length-
y[1].length&&(this.started=!1);this.callback(this.manager,v,{pointers:y[0],changedPointers:y[1],pointerType:"touch",srcEvent:n})}}});var Na={touchstart:1,touchmove:2,touchend:4,touchcancel:8},Ca="touchstart touchmove touchend touchcancel";l(T,D,{handler:function(n){var v=Na[n.type],y=S.call(this,n,v);y&&this.callback(this.manager,v,{pointers:y[0],changedPointers:y[1],pointerType:"touch",srcEvent:n})}});l(ia,D,{handler:function(n,v,y){var B="mouse"==y.pointerType;if(!(B&&y.sourceCapabilities&&y.sourceCapabilities.firesTouchEvents)){if("touch"==
y.pointerType)v&1?(this.primaryTouch=y.changedPointers[0].identifier,W.call(this,y)):v&12&&W.call(this,y);else{if(B)a:{B=y.srcEvent.clientX;for(var C=y.srcEvent.clientY,E=0;E<this.lastTouches.length;E++){var H=this.lastTouches[E],N=Math.abs(C-H.y);if(25>=Math.abs(B-H.x)&&25>=N){B=!0;break a}}B=!1}if(B)return}this.callback(n,v,y)}},destroy:function(){this.touch.destroy();this.mouse.destroy()}});var ya=A(Fa.style,"touchAction"),za=ya!==e,pa=function(){if(!za)return!1;var n={},v=b.CSS&&b.CSS.supports;
"auto;manipulation;pan-y;pan-x;pan-x pan-y;none".split(";").forEach(function(y){n[y]=v?b.CSS.supports("touch-action",y):!0});return n}();ea.prototype={set:function(n){"compute"==n&&(n=this.compute());za&&this.manager.element.style&&pa[n]&&(this.manager.element.style[ya]=n);this.actions=n.toLowerCase().trim()},update:function(){this.set(this.manager.options.touchAction)},compute:function(){var n=[];h(this.manager.recognizers,function(v){q(v.options.enable,[v])&&(n=n.concat(v.getTouchAction()))});return ma(n.join(" "))},
preventDefaults:function(n){var v=n.srcEvent,y=n.offsetDirection;if(this.manager.session.prevented)v.preventDefault();else{var B=this.actions,C=-1<B.indexOf("none")&&!pa.none,E=-1<B.indexOf("pan-y")&&!pa["pan-y"];B=-1<B.indexOf("pan-x")&&!pa["pan-x"];if(C){var H=2>n.distance,N=250>n.deltaTime;if(1===n.pointers.length&&H&&N)return}if(!B||!E)if(C||E&&y&6||B&&y&24)return this.preventSrc(v)}},preventSrc:function(n){this.manager.session.prevented=!0;n.preventDefault()}};P.prototype={defaults:{},set:function(n){Z(this.options,
n);this.manager&&this.manager.touchAction.update();return this},recognizeWith:function(n){if(g(n,"recognizeWith",this))return this;var v=this.simultaneous;n=aa(n,this);v[n.id]||(v[n.id]=n,n.recognizeWith(this));return this},dropRecognizeWith:function(n){if(g(n,"dropRecognizeWith",this))return this;n=aa(n,this);delete this.simultaneous[n.id];return this},requireFailure:function(n){if(g(n,"requireFailure",this))return this;var v=this.requireFail;n=aa(n,this);-1===u(v,n)&&(v.push(n),n.requireFailure(this));
return this},dropRequireFailure:function(n){if(g(n,"dropRequireFailure",this))return this;n=aa(n,this);n=u(this.requireFail,n);-1<n&&this.requireFail.splice(n,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(n){return!!this.simultaneous[n.id]},emit:function(n){function v(C){y.manager.emit(C,n)}var y=this,B=this.state;8>B&&v(y.options.event+ja(B));v(y.options.event);n.additionalEvent&&v(n.additionalEvent);8<=B&&v(y.options.event+ja(B))},tryEmit:function(n){if(this.canEmit())return this.emit(n);
this.state=32},canEmit:function(){for(var n=0;n<this.requireFail.length;){if(!(this.requireFail[n].state&33))return!1;n++}return!0},recognize:function(n){n=Z({},n);q(this.options.enable,[this,n])?(this.state&56&&(this.state=1),this.state=this.process(n),this.state&30&&this.tryEmit(n)):(this.reset(),this.state=32)},process:function(n){},getTouchAction:function(){},reset:function(){}};l(R,P,{defaults:{pointers:1},attrTest:function(n){var v=this.options.pointers;return 0===v||n.pointers.length===v},
process:function(n){var v=this.state,y=n.eventType,B=v&6;n=this.attrTest(n);return B&&(y&8||!n)?v|16:B||n?y&4?v|8:v&2?v|4:2:32}});l(fa,R,{defaults:{event:"pan",threshold:10,pointers:1,direction:30},getTouchAction:function(){var n=this.options.direction,v=[];n&6&&v.push("pan-y");n&24&&v.push("pan-x");return v},directionTest:function(n){var v=this.options,y=!0,B=n.distance,C=n.direction,E=n.deltaX,H=n.deltaY;C&v.direction||(v.direction&6?(C=0===E?1:0>E?2:4,y=E!=this.pX,B=Math.abs(n.deltaX)):(C=0===
H?1:0>H?8:16,y=H!=this.pY,B=Math.abs(n.deltaY)));n.direction=C;return y&&B>v.threshold&&C&v.direction},attrTest:function(n){return R.prototype.attrTest.call(this,n)&&(this.state&2||!(this.state&2)&&this.directionTest(n))},emit:function(n){this.pX=n.deltaX;this.pY=n.deltaY;var v=na(n.direction);v&&(n.additionalEvent=this.options.event+v);this._super.emit.call(this,n)}});l(ka,R,{defaults:{event:"pinch",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,
n)&&(Math.abs(n.scale-1)>this.options.threshold||this.state&2)},emit:function(n){1!==n.scale&&(n.additionalEvent=this.options.event+(1>n.scale?"in":"out"));this._super.emit.call(this,n)}});l(ba,P,{defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return["auto"]},process:function(n){var v=this.options,y=n.pointers.length===v.pointers,B=n.distance<v.threshold,C=n.deltaTime>v.time;this._input=n;if(!B||!y||n.eventType&12&&!C)this.reset();else if(n.eventType&1)this.reset(),
this._timer=f(function(){this.state=8;this.tryEmit()},v.time,this);else if(n.eventType&4)return 8;return 32},reset:function(){clearTimeout(this._timer)},emit:function(n){8===this.state&&(n&&n.eventType&4?this.manager.emit(this.options.event+"up",n):(this._input.timeStamp=qa(),this.manager.emit(this.options.event,this._input)))}});l(X,R,{defaults:{event:"rotate",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,n)&&(Math.abs(n.rotation)>
this.options.threshold||this.state&2)}});l(ca,R,{defaults:{event:"swipe",threshold:10,velocity:.3,direction:30,pointers:1},getTouchAction:function(){return fa.prototype.getTouchAction.call(this)},attrTest:function(n){var v=this.options.direction;if(v&30)var y=n.overallVelocity;else v&6?y=n.overallVelocityX:v&24&&(y=n.overallVelocityY);return this._super.attrTest.call(this,n)&&v&n.offsetDirection&&n.distance>this.options.threshold&&n.maxPointers==this.options.pointers&&da(y)>this.options.velocity&&
n.eventType&4},emit:function(n){var v=na(n.offsetDirection);v&&this.manager.emit(this.options.event+v,n);this.manager.emit(this.options.event,n)}});l(la,P,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return["manipulation"]},process:function(n){var v=this.options,y=n.pointers.length===v.pointers,B=n.distance<v.threshold,C=n.deltaTime<v.time;this.reset();if(n.eventType&1&&0===this.count)return this.failTimeout();if(B&&C&&y){if(4!=
n.eventType)return this.failTimeout();y=this.pTime?n.timeStamp-this.pTime<v.interval:!0;B=!this.pCenter||O(this.pCenter,n.center)<v.posThreshold;this.pTime=n.timeStamp;this.pCenter=n.center;this.count=B&&y?this.count+1:1;this._input=n;if(0===this.count%v.taps)return this.hasRequireFailures()?(this._timer=f(function(){this.state=8;this.tryEmit()},v.interval,this),2):8}return 32},failTimeout:function(){this._timer=f(function(){this.state=32},this.options.interval,this);return 32},reset:function(){clearTimeout(this._timer)},
...
ra.prototype={set:function(n){Z(this.options,n);n.touchAction&&this.touchAction.update();n.inputTarget&&(this.input.destroy(),this.input.target=n.inputTarget,this.input.init());return this},stop:function(n){this.session.stopped=n?2:1},recognize:function(n){var v=this.session;if(!v.stopped){this.touchAction.preventDefaults(n);var y=this.recognizers,B=v.curRecognizer;if(!B||B&&B.state&8)B=v.curRecognizer=null;for(var C=0;C<y.length;){var E=y[C];2===v.stopped||B&&E!=B&&!E.canRecognizeWith(B)?E.reset():
E.recognize(n);!B&&E.state&14&&(B=v.curRecognizer=E);C++}}},get:function(n){if(n instanceof P)return n;for(var v=this.recognizers,y=0;y<v.length;y++)if(v[y].options.event==n)return v[y];return null},add:function(n){if(g(n,"add",this))return this;var v=this.get(n.options.event);v&&this.remove(v);this.recognizers.push(n);n.manager=this;this.touchAction.update();return n},remove:function(n){if(g(n,"remove",this))return this;if(n=this.get(n)){var v=this.recognizers;n=u(v,n);-1!==n&&(v.splice(n,1),this.touchAction.update())}return this},
on:function(n,v){if(n!==e&&v!==e){var y=this.handlers;h(r(n),function(B){y[B]=y[B]||[];y[B].push(v)});return this}},off:function(n,v){if(n!==e){var y=this.handlers;h(r(n),function(B){v?y[B]&&y[B].splice(u(y[B],v),1):delete y[B]});return this}},emit:function(n,v){this.options.domEvents&&Ea(n,v);var y=this.handlers[n]&&this.handlers[n].slice();if(y&&y.length)for(v.type=n,v.preventDefault=function(){v.srcEvent.preventDefault()},n=0;n<y.length;)y[n](v),n++},destroy:function(){this.element&&wa(this,!1);
...
f.parameters.zoomFlag=!1;f.parameters.zoomOut=!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,m=0,q=0,p=0;f.animateInterval=function(x,t){k=$.easing.swing(null,m,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,m,f.parameters.height,f.parameters.height*
(g-1),20);q=$.easing.swing(null,m,f.parameters.left,f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);p=$.easing.swing(null,m,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:q+"px",top:p+"px"});for(var r=0;r<f.side.pageArray.length;r++)if(f.side.pageArray[r])f.side.pageArray[r].onResize(k/2,l);m++;if(20<=m||x>=t){f.animateInterval.stop();
...
100;var q=e*h,p=e*k,x=0,t=0,r=0,u=0;toolBar&&(x=0===toolBar.getTopHeight()?0:toolBar.getTopHeight()+10,t=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,r=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,u=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(q>windowWidth){var w=windowWidth-q-l+h*e*d.parameters.zoomArea.right/100-u;l=-l-h*e*d.parameters.zoomArea.left/100+r}else w=-l-h*e*d.parameters.zoomArea.left/100+r,l=windowWidth-q-l+h*e*d.parameters.zoomArea.right/100-
u;p>windowHeight?(h=windowHeight-p-m+k*e*d.parameters.zoomArea.bottom/100-t,d=-m-k*e*d.parameters.zoomArea.top/100+x):(h=-m-k*e*d.parameters.zoomArea.top/100+x,d=windowHeight-p-m+k*e*d.parameters.zoomArea.bottom/100-t);g=Number.between(g,w,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,
...
$(this).width();this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(q,p){m(q,p,"Sine")}).animation(this,300)}.bind(this),m=function(q,p,x){if(q<p){x=k(null,q,this.parameters.tran.x,e.x-this.parameters.tran.x,p);var t=k(null,q,this.parameters.tran.y,e.y-this.parameters.tran.y,p);q=k(null,q,this.parameters.scale,d-this.parameters.scale,p);p={};p.scale=
q;p.tran={x:x,y:t};x=transformCSS(p);this.css(x)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(q){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=
...
p.data[k+1]/255*t.g),p.data[k+2]!=t.b&&(x.data[k+2]=p.data[k+2]/255*t.b));h.putImageData(x,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(u){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(w){}})}}}}};
...
!0;m=new Date;r=(m-l)/20;var u=h-f,w=k-g;0==r?t=x=0:(x=u/r,t=w/r);void 0!=b&&b(x,t);window.clearInterval(q);q=-1}var f,g,h,k,l,m,q=-1,p=!1,x=0,t=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(r){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(r){}};
...
(function(b){function c(t,r){var u=(t&65535)+(r&65535);return(t>>16)+(r>>16)+(u>>16)<<16|u&65535}function d(t,r,u,w,z,A){t=c(c(r,t),c(w,A));return c(t<<z|t>>>32-z,u)}function e(t,r,u,w,z,A,F){return d(r&u|~r&w,t,r,z,A,F)}function f(t,r,u,w,z,A,F){return d(r&w|u&~w,t,r,z,A,F)}function g(t,r,u,w,z,A,F){return d(u^(r|~w),t,r,z,A,F)}function h(t,r){t[r>>5]|=128<<r%32;t[(r+64>>>9<<4)+14]=r;var u=1732584193,w=-271733879,z=-1732584194,A=271733878;for(r=0;r<t.length;r+=16){var F=u;var D=w;var L=z;var M=A;
u=e(u,w,z,A,t[r],7,-680876936);A=e(A,u,w,z,t[r+1],12,-389564586);z=e(z,A,u,w,t[r+2],17,606105819);w=e(w,z,A,u,t[r+3],22,-1044525330);u=e(u,w,z,A,t[r+4],7,-176418897);A=e(A,u,w,z,t[r+5],12,1200080426);z=e(z,A,u,w,t[r+6],17,-1473231341);w=e(w,z,A,u,t[r+7],22,-45705983);u=e(u,w,z,A,t[r+8],7,1770035416);A=e(A,u,w,z,t[r+9],12,-1958414417);z=e(z,A,u,w,t[r+10],17,-42063);w=e(w,z,A,u,t[r+11],22,-1990404162);u=e(u,w,z,A,t[r+12],7,1804603682);A=e(A,u,w,z,t[r+13],12,-40341101);z=e(z,A,u,w,t[r+14],17,-1502002290);
w=e(w,z,A,u,t[r+15],22,1236535329);u=f(u,w,z,A,t[r+1],5,-165796510);A=f(A,u,w,z,t[r+6],9,-1069501632);z=f(z,A,u,w,t[r+11],14,643717713);w=f(w,z,A,u,t[r],20,-373897302);u=f(u,w,z,A,t[r+5],5,-701558691);A=f(A,u,w,z,t[r+10],9,38016083);z=f(z,A,u,w,t[r+15],14,-660478335);w=f(w,z,A,u,t[r+4],20,-405537848);u=f(u,w,z,A,t[r+9],5,568446438);A=f(A,u,w,z,t[r+14],9,-1019803690);z=f(z,A,u,w,t[r+3],14,-187363961);w=f(w,z,A,u,t[r+8],20,1163531501);u=f(u,w,z,A,t[r+13],5,-1444681467);A=f(A,u,w,z,t[r+2],9,-51403784);
z=f(z,A,u,w,t[r+7],14,1735328473);w=f(w,z,A,u,t[r+12],20,-1926607734);u=d(w^z^A,u,w,t[r+5],4,-378558);A=d(u^w^z,A,u,t[r+8],11,-2022574463);z=d(A^u^w,z,A,t[r+11],16,1839030562);w=d(z^A^u,w,z,t[r+14],23,-35309556);u=d(w^z^A,u,w,t[r+1],4,-1530992060);A=d(u^w^z,A,u,t[r+4],11,1272893353);z=d(A^u^w,z,A,t[r+7],16,-155497632);w=d(z^A^u,w,z,t[r+10],23,-1094730640);u=d(w^z^A,u,w,t[r+13],4,681279174);A=d(u^w^z,A,u,t[r],11,-358537222);z=d(A^u^w,z,A,t[r+3],16,-722521979);w=d(z^A^u,w,z,t[r+6],23,76029189);u=d(w^
z^A,u,w,t[r+9],4,-640364487);A=d(u^w^z,A,u,t[r+12],11,-421815835);z=d(A^u^w,z,A,t[r+15],16,530742520);w=d(z^A^u,w,z,t[r+2],23,-995338651);u=g(u,w,z,A,t[r],6,-198630844);A=g(A,u,w,z,t[r+7],10,1126891415);z=g(z,A,u,w,t[r+14],15,-1416354905);w=g(w,z,A,u,t[r+5],21,-57434055);u=g(u,w,z,A,t[r+12],6,1700485571);A=g(A,u,w,z,t[r+3],10,-1894986606);z=g(z,A,u,w,t[r+10],15,-1051523);w=g(w,z,A,u,t[r+1],21,-2054922799);u=g(u,w,z,A,t[r+8],6,1873313359);A=g(A,u,w,z,t[r+15],10,-30611744);z=g(z,A,u,w,t[r+6],15,-1560198380);
w=g(w,z,A,u,t[r+13],21,1309151649);u=g(u,w,z,A,t[r+4],6,-145523070);A=g(A,u,w,z,t[r+11],10,-1120210379);z=g(z,A,u,w,t[r+2],15,718787259);w=g(w,z,A,u,t[r+9],21,-343485551);u=c(u,F);w=c(w,D);z=c(z,L);A=c(A,M)}return[u,w,z,A]}function k(t){var r,u="",w=32*t.length;for(r=0;r<w;r+=8)u+=String.fromCharCode(t[r>>5]>>>r%32&255);return u}function l(t){var r,u=[];u[(t.length>>2)-1]=void 0;for(r=0;r<u.length;r+=1)u[r]=0;var w=8*t.length;for(r=0;r<w;r+=8)u[r>>5]|=(t.charCodeAt(r/8)&255)<<r%32;return u}function m(t){return k(h(l(t),
8*t.length))}function q(t,r){var u=l(t),w=[],z=[];w[15]=z[15]=void 0;16<u.length&&(u=h(u,8*t.length));for(t=0;16>t;t+=1)w[t]=u[t]^909522486,z[t]=u[t]^1549556828;r=h(w.concat(l(r)),512+8*r.length);return k(h(z.concat(r),640))}function p(t){var r="",u;for(u=0;u<t.length;u+=1){var w=t.charCodeAt(u);r+="0123456789abcdef".charAt(w>>>4&15)+"0123456789abcdef".charAt(w&15)}return r}function x(t,r,u){r?u?t=q(unescape(encodeURIComponent(r)),unescape(encodeURIComponent(t))):(t=q(unescape(encodeURIComponent(r)),
...
function debounceAsyncByKey(b,c,d){var e={},f={};d=d||function(g){return g[0]};return function(g){for(var h=[],k=0;k<arguments.length;++k)h[k-0]=arguments[k];var l=this;k=d(h);var m=void 0!==k&&null!==k?k:"__default__";e[m]&&clearTimeout(e[m]);return new Promise(function(q,p){f[m]||(f[m]=[]);f[m].push({resolve:q,reject:p});e[m]=setTimeout(function(){var x,t,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){switch(u.nextAddress){case 1:return x=f[m],u.setCatchFinallyBlocks(2,3),u.yield(b.apply(l,
h),5);case 5:t=u.yieldResult,x&&x.forEach(function(w){return w.resolve(t)});case 3:u.enterFinallyBlock();delete e[m];delete f[m];u.leaveFinallyBlock(0);break;case 2:r=u.enterCatchBlock(),x&&x.forEach(function(w){return w.reject(r)}),u.jumpTo(3)}})},c)})}}
...
k.src=b;k.onload=function(){var l=document.createElement("canvas"),m=l.getContext("2d",{willReadFrequently:!0});l.width=k.width;l.height=k.height;m.drawImage(k,0,0);for(var q=m.getImageData(0,0,l.width,l.height),p=q.data,x=c?e(c):null,t=d?e(d):{r:0,g:0,b:0,a:0},r=0;r<p.length;r+=4){var u=p[r+3];0===u?(p[r]=t.r,p[r+1]=t.g,p[r+2]=t.b,p[r+3]=void 0!==t.a?t.a:0):0<u&&255>u?x&&(p[r]=Math.round((x.r*u+t.r*(255-u))/255),p[r+1]=Math.round((x.g*u+t.g*(255-u))/255),p[r+2]=Math.round((x.b*u+t.b*(255-u))/255),
p[r+3]=255):x&&(p[r]=x.r,p[r+1]=x.g,p[r+2]=x.b,p[r+3]=void 0!==x.a?x.a:255)}m.putImageData(q,0,0);g(l.toDataURL())};k.onerror=function(l){return h(l)}})}var getRandomColor=function(){return"#"+Math.floor(1118481+14540253*Math.random()).toString(16)};function normalizeUrl(b){return b&&"string"===typeof b?b.replace(/\\\//g,"/"):b}
(function(b){function c(){null==b.pageTextPositions&&(b.pageTextPositions=[]);return b.pageTextPositions}function d(p,x){var t=c();try{var r=x&&"object"===typeof x?Object.assign({},x):x;if(r&&"object"===typeof r){r.page=Number(p+1);var u=t[p];u&&u.positions&&r.positions?r.positions=u.positions.concat(r.positions):u&&u.positions&&(r.positions=u.positions);null!=l?r.realPage=Number(l):u&&u.realPage&&(r.realPage=u.realPage);u&&Object.keys(u).forEach(function(w){"page"===w||"realPage"===w||"positions"===
w||w in r||(r[w]=u[w])})}t[p]=r;return!0}catch(w){return console.error("writeToTarget error",w),!1}}function e(p,x,t){if(!p||0===p.length)return null;for(var r=p[0].left,u=p[0].top,w=p[0].right,z=p[0].bottom,A="",F=0;F<p.length;F++){var D=p[F];r=Math.min(r,D.left);u=Math.min(u,D.top);w=Math.max(w,D.right);z=Math.max(z,D.bottom);A+=D.text||""}F=r/x;u/=t;w/=x;t=z/t;t=[F,t,w,t,w,u,F,u];z=[];for(F=0;F<p.length;F++)z.push(p[F].width/x);if(!A||0===A.trim().length)return null;p=t.concat(z);return{w:A,p:p}}
function f(p){b._pageReaderExtracted||(b._pageReaderExtracted={});p=Array.isArray(p)?p:[p];for(var x=0,t=0;t<p.length;t++){var r=p[t];if(r&&!(1>r)&&!b._pageReaderExtracted[r])if(b._pageReaderExtracted[r]=!0,window._getPage&&"function"===typeof window._getPage)try{var u=window._getPage(r-1);if(u){var w=null;if(u.items&&Array.isArray(u.items)){w=u.items;for(var z=window.readerConfig.pageConfig.pageWidth,A=window.readerConfig.pageConfig.pageHeight,F=0,D=0;D<w.length;D++){var L=w[D];if(L&&"text"===L.type&&
L.positionText&&L.style){var M=L,I=r,G=z,O=A,K=c();b.pageTextPositions||(b.pageTextPositions=[]);var J=M;if(J&&J.positionText&&J.style){M=[];var Q=parseFloat(J.style.left)||0,U=parseFloat(J.style.top)||0,T=J.positionText;for(J=0;J<T.length;J++){var S=T[J];if(S&&S.rowText&&0!==S.rowText.length){for(var ia=S.rowText,W=[],ea=null,ma=0;ma<ia.length;ma++){var P=ia[ma];if(P&&P.text){var ja=Q+(P.left||0),na=U+(P.top||0),aa=P.width||0,R=P.height||0,fa=ja+aa,ka=!1;null!==ea&&ja-ea>.5*aa&&(ka=!0);if(ka&&0<
...
la)}else console.warn("PageTextExtractor: window._getPage \u65b9\u6cd5\u4e0d\u5b58\u5728\uff0c\u65e0\u6cd5\u63d0\u53d6\u6587\u672c\u914d\u7f6e")}return x}function g(p){var x,t,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){if(!p||1>p)return u.return(!1);b._positionScriptLoaded||(b._positionScriptLoaded={});b._positionScriptLoadPromises||(b._positionScriptLoadPromises={});x=b.getSearchRealPageIndex(p);if(0>=x||-1===x||b._positionScriptLoaded[x])return u.return(!1);if(t=b._positionScriptLoadPromises[x])return u.return(t);
r=function(){var w,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:return D.setCatchFinallyBlocks(2,3),w=String.format(bookConfig.searchPositionJS,x),1<x&&(w=w.replace("[1]","["+x+"]")),z=/\.*\/?(\w+\/)*\w+(\[|\()?\d+(\]|\))?\.js/gi,A=/\.*\/?(\w+\/)*\w+?\.js/gi,w.match(z)||w.match(A)?D.yield(getArticleImage(fixURLValue(w)),5):D.return(!1);case 5:return(w=D.yieldResult)?D.yield(h(p,w,x),6):D.return(!1);case 6:return b._positionScriptLoaded[x]=!0,D.return(!0);
case 3:D.enterFinallyBlock();delete b._positionScriptLoadPromises[x];D.leaveFinallyBlock(0);break;case 2:return F=D.enterCatchBlock(),console.error("loadPagePositionScript: \u52a0\u8f7d\u5931\u8d25",F),D.return(!1)}})}();b._positionScriptLoadPromises[x]=r;return u.return(r)})}function h(p,x,t){var r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){r=function(){var w,z,A,F,D,L,M,I;return $jscomp.asyncExecutePromiseGeneratorProgram(function(G){switch(G.nextAddress){case 1:k=p;l=t;if(w=
...
x;J.onload=function(){setTimeout(function(){l=k=null;O()},0)};J.onerror=function(Q){l=k=null;console.log("Script load failed:",x,Q);K(Error("Script load failed: "+x))};J.src=x;I.document.head.appendChild(J)}),0):(console.log("\u65e0\u6cd5\u627e\u5230 window \u6216 global \u5bf9\u8c61"),G.return())}})};m=m.then(function(){return r()}).catch(function(w){console.log("queue error:",w&&w.message)});return u.return(m)})}"undefined"!==typeof b&&null==b.pageTextPositions&&(b.pageTextPositions=[]);var k=null,
l=null,m=Promise.resolve(),q=new Proxy({},{get:function(p,x){var t=c();return"string"===typeof x&&/^\d+$/.test(x)?t[Number(x)]:"length"===x?t.length:"function"===typeof Array.prototype[x]?Array.prototype[x].bind(t):p[x]},set:function(p,x,t){return"string"===typeof x&&/^\d+$/.test(x)?(p=Number(x),null!=k?d(k-1,t):d(p,t),!0):!1},has:function(p,x){var t=c();return"string"===typeof x&&/^\d+$/.test(x)?Number(x)in t:x in p},ownKeys:function(){var p=c();return Object.keys(p).concat(Object.getOwnPropertyNames(Object.prototype))},
getOwnPropertyDescriptor:function(p,x){var t=c();return"string"===typeof x&&/^\d+$/.test(x)?{configurable:!0,enumerable:!0,value:t[Number(x)],writable:!0}:Object.getOwnPropertyDescriptor(p,x)}});"undefined"!==typeof window?Object.defineProperty(window,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:q}):"undefined"!==typeof b&&Object.defineProperty(b,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:q});"undefined"!==typeof b&&null==b._positionScriptLoadPromises&&
(b._positionScriptLoadPromises={});b.extractPageTextConfigs=f;b.loadPageTextInfo=function(p){var x,t,r,u,w,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:b._positionScriptLoaded||(b._positionScriptLoaded={}),b._pageReaderExtracted||(b._pageReaderExtracted={}),b.pageTextPositions||(b.pageTextPositions=[]),x=Array.isArray(p)?p:[p],t=[],r=!1,u=0;case 2:if(!(u<x.length)){D.jumpTo(4);break}w=x[u];if(!w||1>w){D.jumpTo(3);break}z={pageIndex:w,hasText:!1,
positionCount:0};D.setCatchFinallyBlocks(5);return D.yield(g(w),7);case 7:b._pageReaderExtracted[w]||f(w);(A=c()[w-1])&&A.page===w&&A.positions&&Array.isArray(A.positions)&&0<A.positions.length&&(z.hasText=!0,z.positionCount=A.positions.length,r=!0);D.leaveTryBlock(6);break;case 5:F=D.enterCatchBlock(),console.log("loadPageTextInfo: \u52a0\u8f7d\u9875\u9762 "+w+" \u7684\u6587\u672c\u4fe1\u606f\u65f6\u51fa\u9519",F);case 6:t.push(z);case 3:u++;D.jumpTo(2);break;case 4:return D.return({hasText:r,pageResults:t})}})};
b.hasPageText=function(p){b.pageTextPositions||(b.pageTextPositions=[]);var x=!Array.isArray(p),t=[],r=!1;p=$jscomp.makeIterator(x?[p]:p);for(var u=p.next();!u.done;u=p.next())if(u=u.value,!u||1>u)x||t.push({pageIndex:u,hasText:!1,positionCount:0});else{var w={pageIndex:u,hasText:!1,positionCount:0},z=u-1;(z=c()[z])&&z.page===u&&z.positions&&Array.isArray(z.positions)&&0<z.positions.length&&(w.hasText=!0,w.positionCount=z.positions.length,r=!0);if(x)return w.hasText;t.push(w)}return{hasText:r,pageResults:t}};
...
tmpBookConfig.logoHeight=getConfigValue("logoHeight",40);tmpBookConfig.logoTop=getConfigValue("logoTop",0);tmpBookConfig.logoPadding=getConfigValue("logoPadding",0);tmpBookConfig.isFixLogoSize=getConfigValue("isFixLogoSize",!1);tmpBookConfig.HomeButtonVisible=getConfigValue("HomeButtonVisible",!1);tmpBookConfig.ShareButtonVisible=getConfigValue("ShareButtonVisible",!1);tmpBookConfig.facebookAppId=getConfigValue("facebookAppId","");tmpBookConfig.isInsertFrameLinkEnable=getConfigValue("isInsertFrameLinkEnable",
...
tmpBookConfig.BindingType;tmpBookConfig.ToolbarViewMode=getConfigValue("ToolbarViewMode","standard");tmpBookConfig.ToolbarViewMode=tmpBookConfig.ToolbarViewMode.toLocaleLowerCase();tmpBookConfig.isTheBookOpen=getConfigValue("isTheBookOpen",!1);tmpBookConfig.FlipDirection=getConfigValue("FlipDirection",0);tmpBookConfig.FlipDirectiononMobile=getConfigValue("FlipDirectiononMobile",void 0);void 0!==tmpBookConfig.FlipDirectiononMobile&&(e=Number(tmpBookConfig.FlipDirectiononMobile),tmpBookConfig.FlipDirectiononMobile=
0===e||1===e?e:void 0);(isPhone()||isPad())&&void 0!==tmpBookConfig.FlipDirectiononMobile&&(tmpBookConfig.FlipDirection=tmpBookConfig.FlipDirectiononMobile);tmpBookConfig.continuousPageArrangement=getConfigValue("continuousPageArrangement",!0);tmpBookConfig.startingFromTheSide=getConfigValue("startingFromTheSide",!1);tmpBookConfig.automaticAdsorption=getConfigValue("automaticAdsorption",!0);tmpBookConfig.phoneFlipShortcutSwitchButtonIcon=getConfigValue("phoneFlipShortcutSwitchButtonIcon","");tmpBookConfig.HomeButtonIcon=
...
(tmpBookConfig.isFirstLastShortcutVisible=!!tmpBookConfig.flipshortcutbutton);if(global.videoList&&1<=global.videoList.length)for(f=0;f<videoList.length;f++)videoList[f].id||(videoList[f].id=""),videoList[f].description||(videoList[f].description=""),videoList[f].thumbnail||(videoList[f].thumbnail=""),videoList[f].title||(videoList[f].title=""),videoList[f].type||(videoList[f].type="");try{window.localStorage||(tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.restorePageVisible=
!1,global.pageEditor&&global.pageEditor.setting&&parseBool(global.pageEditor.setting.shoppingCartHTML)&&(global.pageEditor.setting.shoppingCartHTML=!1))}catch(m){tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.restorePageVisible=!1,global.pageEditor&&global.pageEditor.setting&&parseBool(global.pageEditor.setting.shoppingCartHTML)&&(global.pageEditor.setting.shoppingCartHTML=!1)}global.templeteName.includes("article")&&(isPhone()||isPad())&&(tmpBookConfig.BookMarkButtonVisible=
...
"Only open in iframe.");tmpBookConfig.NoWechatSharing&&jQuery(document).ready(function(){window.setTimeout(function(){function m(){WeixinJSBridge.call("hideOptionMenu")}global.wx&&wx.hideOptionMenu();"undefined"==typeof WeixinJSBridge?document.addEventListener?document.addEventListener("WeixinJSBridgeReady",m,!1):document.attachEvent&&(document.attachEvent("WeixinJSBridgeReady",m),document.attachEvent("onWeixinJSBridgeReady",m)):m()},10)});tmpBookConfig.textClarityEnhancement=getConfigValue("textClarityEnhancement",
0);tmpBookConfig.textSharpening=getConfigValue("textSharpening",!0);tmpBookConfig.textSharpening=!1;tmpBookConfig.AboutDescription=tmpBookConfig.AboutDescription.replace(/\n|\\n/g,"<br/>").replace(/\r|\\r/g,"<br/>");checkBookmarkConfig();checkStaticAdConfig();isBelowIE9()&&(tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.WeChatShareButtonVisible=!1);tmpBookConfig.useTheAliCloudChart&&tmpBookConfig.backGroundImgURL&&(0<=tmpBookConfig.backGroundImgURL.indexOf("?")?
...
"");tmpBookConfig.isMouseEnterToDisplayArticleTitle=getConfigValue("isMouseEnterToDisplayArticleTitle",!1);tmpBookConfig.delayToFlipFirst=getConfigValue("delayToFlipFirst",!1);tmpBookConfig.timeToFlipFirst=getConfigValue("timeToFlipFirst",10);tmpBookConfig.printBackgroundPosition=getConfigValue("printBackgroundPosition","fit");try{if(window.ignoreModuleArray&&window.ignoreModuleArray.bookConfig)for(f=0;f<window.ignoreModuleArray.bookConfig.length;f++)g=window.ignoreModuleArray.bookConfig[f],void 0!=
tmpBookConfig[g]&&(tmpBookConfig[g]=!1)}catch(m){}checkFlipStyleConfig();return"issuu"==tmpBookConfig.FlipStyle?l.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/issuubook.min.css"),7):l.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/flipbook.min.css"),7);case 7:return checkPageEditorConfig(),recordError(),h=Module._getVerifyString(),k=UTF8ToString(h),Module._free(h),l.yield(runDecryptedScript(k),0)}})};
...
function getLocalBookmarkExists(){try{if(!window.localStorage)return!1;var b=window.location.href.replace(window.location.hash,"").replace(window.location.search,"")+"BookMark";if(!window.localStorage[b])return!1;var c=window.localStorage.getItem(b),d=Instance.parse(c,[]);return Array.isArray(d)&&0<d.length}catch(e){return!1}}
function setBookVerticalMargin(b){b=void 0===b?{}:b;try{var c=global.staticAd&&global.staticAd.haveAd&&"Chinese"!=UserGroups&&global.staticAd.adPosition?!0:!1,d=global.staticAd.height||90,e=tmpBookConfig.ORIGIN_TOP_MARGIN,f,g=null!=(f=b.bookmarkHeight)?f:70,h,k,l,m=!(null==(h=global.bmtConfig)?0:h.onSideEdge)&&0<((null==(k=global.bmtConfig)?void 0:null==(l=k.tabs)?void 0:l.length)||0),q,p=!(null==(q=global.bmtConfig)?0:q.onSideEdge)&&getLocalBookmarkExists();(m||p)&&e<g&&(e=g);if(c&&2==global.staticAd.adPosition)if(e<
d+20)e+=d+20;else{var x=BookInfo.top()-templateArea.getTopHeight();e=Math.max(e,x)}tmpBookConfig.topMargin=e;var t=tmpBookConfig.ORIGIN_BOTTOM_MARGIN;c&&1==global.staticAd.adPosition&&t<d+20&&(t+=d+20);tmpBookConfig.bottomMargin=t;b.disableResize||"function"!=typeof global.onStageResize||onStageResize()}catch(r){console.log("setBookVerticalMargin error",r)}}
...
b){case 1:tmpBookConfig.bottomMargin=tmpBookConfig.bottomMargin+c+20;break;case 2:tmpBookConfig.topMargin=tmpBookConfig.topMargin+c+20}}}
...
function getArticleEditor(){function b(u){if(window.isExecuteGetInverseEditor)var w=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(w),u()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),u(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(z){d(z,u)},u,"")}function c(u,w,z,A,F){var D=new XMLHttpRequest;D.responseType=
void 0===A?"json":A;D.open("GET",u);D.send();D.onreadystatechange=function(){4===D.readyState&&(200===D.status||304===D.status?w&&w(D):"bookinfo"===F&&w?w():z&&z(w))};D.error=function(){z&&z(w)}}function d(u,w){r&&(clearTimeout(r),r=null);if(window.Module.isReady){var z=allocateUTF8(u.responseText),A=Module._DeString(z),F=UTF8ToString(A);F=eval(F);Module._free(z);Module._FreeMemory(A);e(F);w();window.runArticleEditor&&delete window.runArticleEditor}else r=setTimeout(function(){d(u,w)},100)}function e(u){(window.articleListConfig=
...
z.push(A.rect))});return z}function m(u,w){var z="";u.forEach(function(A){if(-1!==w&&(A.pageIndex===w||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(D){return D.pageIndex===w}).length))if(""===z)z=A.mergeList&&A.mergeList.length?m(A.mergeList,w):JSON.parse(JSON.stringify(A));else{if(A.mergeList&&A.mergeList.length){var F=[z].concat(A.mergeList);z=m(F,w)}z.rect.x>A.rect.x&&(z.rect.x=A.rect.x);z.rect.y>A.rect.y&&(z.rect.y=A.rect.y);z.rect.endX<A.rect.endX&&(z.rect.endX=A.rect.endX);z.rect.endY<
...
x=0;x<canvasData[b].resources.length;x++)if(1!=canvasData[b].resources[x].type)p++,p>=canvasData[b].resources.length&&k();else{var t=new Image;t.src=getResource(b,x);t.alt="";globalImages[b][x]=t;t.onload=function(){p++;p>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});m.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,m,q,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(x){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(t){bookConfig.largePageWidth/bookConfig.largePageHeight>t[0].naturalWidth/t[0].naturalHeight?t.css({width:"auto",height:"100%"}):t.css({width:"100%",height:"auto"})};for(m=0;m<c.length;m++)q=c[m],q=q.removeStartFrom("?"),p=$("<img alt='' style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),p.attr("src",q),k.append(p),p[0].onload=function(t){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},p[0].onerror=function(t){h++;h==c.length&&
...
function(){this.create(b,c,d)}.bind(h),function(){}),p.return();if(l=global[decodeDatabasePrefix(c)+b]&&"string"==typeof global[decodeDatabasePrefix(c)+b])return m=dataBase64Str(b,c),h.$image=$("<img alt='' src='"+m+"'/>"),h.$image[0].onload=function(){d&&d(m,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(h),p.return();q=h;loadJavascript(k,function(x){var t=dataBase64Str(b,c,x);q.$image=$("<img alt='' src='"+
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),m=Math.ceil(k/2),q=b.getContext("2d",{willReadFrequently:!0}),p=q.getImageData(0,0,f,g),x=q.createImageData(c,d);p=p.data;for(var t=x.data,r=0;r<d;r++)for(var u=0;u<c;u++){for(var w=4*(u+r*c),z,A=0,F=0,D=0,L=0,M=0,I=0,G=(r+.5)*k,O=Math.ceil((r+1)*k),K=Math.floor(r*k);K<O;K++){var J=Math.abs(G-(K+.5))/m,Q=(u+.5)*h;J*=J;for(var U=Math.ceil((u+1)*h),T=Math.floor(u*h);T<U;T++)if(z=
Math.abs(Q-(T+.5))/l,z=Math.sqrt(J+z*z),!(1<=z)){z=2*z*z*z-3*z*z+1;var S=4*(T+K*f);I+=z*p[S+3];F+=z;255>p[S+3]&&(z=z*p[S+3]/250);D+=z*p[S];L+=z*p[S+1];M+=z*p[S+2];A+=z}}t[w]=D/A;t[w+1]=L/A;t[w+2]=M/A;t[w+3]=I/F}!0===e?(b.width=c,b.height=d):q.clearRect(0,0,f,g);q.putImageData(x,0,0)}
...
function(q,p){m(q,p,"Sine")}.animation(this,l)}.bind(this);var m=function(q,p,x){if(!b)return!1;var t=b.pageWidth,r=b.pageHeight,u=$.easing["easeInOut"+x],w=$.easing["easeOut"+x];x=w(null,q,g,b.toPoint.x-g,p);w=w(null,q,h,b.toPoint.y-h,p);b.dragMoveToFlip||(x=u(null,q,g,b.toPoint.x-g,p),w=bookConfig.FlipDirection?f*Math.sqrt(r*r-x*x):r-f*Math.sqrt(t*t-x*x));q<p?this.flipToPoint(b,c,d,b.fromPoint,{x:x,y:w}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,d),BookEvent.trigger("afterFlipPage",
...
0<e.length?e:"error":-1!=e?e:isNaN(parseInt(b))||void 0!==d[parseInt(b)]?"error":parseInt(b)};function getEncodedPageHashValue(b){var c="function"===typeof getShownPageNumber?getShownPageNumber(b):b;if(void 0===c||null===c)c=b;return encodeURIComponent(String(c))}
...
l/25)}.bind(this):function(){k=function(q,p){m(q,p,"Sine")}.animation(this,l)}.bind(this);var m=function(q,p,x){if(!b)return!1;var t=b.pageWidth,r=b.pageHeight,u=$.easing["easeInOut"+x],w=$.easing["easeOut"+x];x=w(null,q,g,b.toPoint.x-g,p);w=w(null,q,h,b.toPoint.y-h,p);b.dragMoveToFlip||(x=u(null,q,g,b.toPoint.x-g,p),w=bookConfig.FlipDirection?f*Math.sqrt(r*r-x*x):r-f*Math.sqrt(t*t-x*x));q<p?this.flipToPoint(b,c,d,b.fromPoint,{x:x,y:w}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
{x:m,y:q},p.rotateY?(p.$page[0].style.removeProperty("transform-origin"),d=void 0,x=transformCSS({scale:{x:m,y:q},perspective:6E3,rotateY:null!=(d=p.rotateY)?d:0})):(d=void 0,x=transformCSS({origin:g,scale:{x:m,y:q},perspective:6E3,rotateY:null!=(d=p.rotateY)?d:0})));p.setCSSByStyle(x);if(p.page.pageFlipShadow){var t=h?transformCSS({scale:{x:k.x/m,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});p.page.pageFlipShadow&&p.page.pageFlipShadow.setCSSByStyle(t)}}}return{x:m,y:q}}catch(r){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},
...
1,d);p=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);c=function(t){if(t){var r=transformCSS({tran:l?l:{x:0,y:0},scale:{x:q,y:p},origin:g});if(m.isCoverPage(t.pageIndex))if(t.tran=l?l:{x:0,y:0},t.scale={x:q,y:p},t.rotateY){t.$page[0].style.removeProperty("transform-origin");var u;r=transformCSS({scale:{x:q,y:p},perspective:6E3,rotateY:null!=(u=t.rotateY)?u:0})}else{var w;r=transformCSS({origin:g,scale:{x:q,y:p},perspective:6E3,rotateY:null!=(w=t.rotateY)?w:0})}t.setCSSByStyle(r);r=h?transformCSS({scale:{x:k.x/
q,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});t.page.pageFlipShadow&&t.page.pageFlipShadow.setCSSByStyle(r)}};for(d=0;d<b.length;d++){var x=this.pageBackArray[b[d]];c(this.pageArray[b[d]]);c(x)}return{x:q,y:p}}catch(t){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,c,d){this.getSpace(!1);var e=this.getSpace(!0);c||(c=windowWidth-e.left-e.right);d||(d=windowHeight-e.top-e.bottom);e=[];b=[b];for(var f=0;f<b.length;f++)b[f]?e.push(window.pageList&&
...
function scrapOriginPageIndex(){window.realLocation=window.location.href.removeStartFrom("?");window.realLocation=realLocation.removeStartFrom("#");var b=bookConfig.OriginPageIndex,c=window.location.hash;""!=c&&3<c.length&&"#p="==c.substr(0,3)&&(b=parseInt(getRealPageNumber(decodeURIComponent(c.substr(3,c.length-3)))));b=Number.between(b,1,originTotalPageCount);if(bookConfig.restorePageVisible&&window.localStorage[realLocation+"?historyPageIndex"]){var d=parseInt(window.localStorage[realLocation+
