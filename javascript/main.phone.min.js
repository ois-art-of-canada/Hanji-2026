...
("undefined"!==typeof b?b:"")).trim(),"string"==typeof r&&(r=r.replaceAll("\\/","/",!0),r=r.replaceAll('\\"','"')),/^(\.\.\/){2}booklogo\.png([?#].*)?$/.test(r)))return""},n,k,m,p,q;if((null==(n=window.tmpBookConfig)?0:null==(k=n.power_info)?0:k.power)||(null==(m=window.bookConfig)?0:null==(p=m.power_info)?0:p.power)||(null==(q=window.userInfo)?0:q.power)||!window.eventEmitter||"function"!==typeof window.eventEmitter.on)return l(h());window.eventEmitter.on("loadUserInfo",function(r){return l(h())})}
...
!1;break}}else{m=!1;break}}m&&(m=[],p=getHighlightRealPageIndex(b),0>p||(m.search_page=p+1,p="page "+(p+1),m.search_title=p,p=f.substring(0,h),p=p.lastIndexOf("."),-1==p?p=0:p++,f=f.substring(l),q=f.indexOf(". "),q=-1==q?l+f.length:l+q+1,f=c.substring(p,q),m.search_text=f,d.push(m)))}else for(b=b.trim(),n=b.toLowerCase(),k=e?HTMLString.removeSpacesAndNewlines(n):n,b=0;b<a.length;b++){c=a[b].trim().replace(/[\r\n]/g," ");f=a[b].trim().toLowerCase().replace(/[\r\n]/g," ");l=h=-1;if(e){if(p=HTMLString.removeSpacesAndNewlines(f).indexOf(k),
-1!==p){m=[];for(q=0;q<f.length;q++)/[\s\r\n]/.test(f[q])||m.push(q);p<m.length&&(h=m[p],l=p+k.length,l=l<=m.length?m[l-1]+1:f.length)}}else h=f.indexOf(n),-1!==h&&(l=h+n.length);-1!==h&&(m=[],p=getHighlightRealPageIndex(b),0>p||(m.search_page=p+1,p="page "+(p+1),m.search_title=p,p=f.substring(0,h),p=p.lastIndexOf("."),-1==p?p=0:p++,f=f.substring(l),q=f.indexOf(". "),q=-1==q?l+f.length:l+q+1,f=c.substring(p,q),e?-1===HTMLString.removeSpacesAndNewlines(f.toLowerCase()).indexOf(k)&&(h=Math.max(0,h-
50),l=Math.min(c.length,l+50),f=c.substring(h,l)):-1===f.toLowerCase().indexOf(n)&&(h=Math.max(0,h-50),l=Math.min(c.length,l+50),f=c.substring(h,l)),m.search_text=f,d.push(m)))}return d}function getSearchRealPageIndex(a){if(!window.search_pages||void 0==search_pages[a-1])return a;var b;(a=search_pages[a-1])&&(b=parseInt(a.index));return isNaN(b)||-1==b?-1:b+1}
...
(null==(g=selectedLanguage)?void 0:null==(h=g.language)?void 0:h.toLowerCase())||"english";this.frame=$("<iframe id='chatbotIframe' allow=\"microphone\" class='chatbot-frame' src='"+(b+"?url="+c+"&desc="+d+"&keyword="+e+"&isRtl="+f+"&lang="+l)+"' ></iframe>");this.frame.on("load",function(){a.onLoadIframe()});this.container.append(this.chatbotBox);this.container.append(this.chatBotBtn);this.parent.append(this.container);this.chatbotBox.css({"box-sizing":"border-box","z-index":9999,position:"absolute",
...
var d=getMetaTagValueByName("description"),e=getMetaTagValueByName("keywords");b+="/chatbot/chatbot.php";c=Metacharacter(c);e=Metacharacter(e);d=Metacharacter(d);var f=this.isRtl()?"1":"0",g,h,l=(null==(g=selectedLanguage)?void 0:null==(h=g.language)?void 0:h.toLowerCase())||"english";this.frame=$("<iframe id='chatbotIframe' allow=\"microphone\" class='chatbot-frame' border='0' width='100%' height='100%' src='"+(b+"?url="+c+"&desc="+d+"&keyword="+e+"&isRtl="+f+"&lang="+l)+"' ></iframe>");this.frame.on("load",
...
this.buttons.add(new DownloadButton);bookConfig.FullscreenButtonVisible&&this.buttons.add(new FullscreenButton);var a=!1;1<language.length&&(a=bookConfig.ClientBookId?1<bookConfig.language.length:1<bookConfig.language.split(";").length);a&&this.buttons.add(new LanguageButton);bookConfig.aboutButtonVisible&&this.buttons.add(new AboutButton);bookConfig.HelpButtonVisible&&this.buttons.add(new HelpButton);bookConfig.EmailButtonVisible&&this.buttons.add(new ShareEmailButton);bookConfig.SelectTextButtonVisible&&
this.buttons.add(new SelectTextButton);bookConfig.MagnifierButtonVisible&&!global.isBelowIE11()&&this.buttons.add(new MagnifierButton);bookConfig.PageModeButtonVisible&&this.buttons.add(new PageModeButton);this.btnMore=new MoreButton;this.buttons.add(this.btnMore);this.sortXMLButton();this.buttons.each(function(b){b.setCallback(this.afterButtonClick.bind(this));this.setButtonTitle(b)}.bind(this))},sortXMLButton:function(){if(bookConfig.buttonsSortXML){var a=bookConfig.buttonsSortXML.slice().reverse(),
b=a.indexOf("autoflip");0<=b&&(a[b]="autoplay");for(b=0;b<a.length;b++){if("btnshare"==a[b]&&bookConfig.ShareButtonVisible){var c=this.getButton("ShareButton","sharethis");this.buttons.remove(c)}else c=this.pickButton(a[b]);c&&(this.buttons.objects.unshift(c),this.buttons.length+=1)}}},resetButtonColor:function(){for(var a=0;a<this.buttons.objects.length;a++){var b=this.buttons.objects[a];b.resetImg();b.color=Color(bookConfig.iconColor);b.fontColor=Color(bookConfig.iconFontColor);b.changeIconColor(bookConfig.iconColor);
b.changeCaptionColor(bookConfig.iconFontColor);b.title&&b.title.setColor({color:bookConfig.toolbarColor,textColor:bookConfig.iconFontColor})}bookConfig.QRCode&&global.qrButton&&global.qrButton.visible&&global.qrButton.resetIconColor()},resetButtonTitleColor:function(){for(var a=0;a<this.buttons.objects.length;a++){var b=this.buttons.objects[a];b.title&&b.title.setColor({color:bookConfig.toolbarColor,textColor:bookConfig.iconFontColor})}},resetToolbarColor:function(){this.color=Color(bookConfig.toolbarColor);
this.topBarAlpha=Math.min(bookConfig.topToolBarAlpha,bookConfig.ToolBarAlpha);this.topBar&&this.topBar.css({"background-color":this.color.rgba(this.topBarAlpha)});this.bottomBar&&this.bottomBar.css("background-color",this.color.rgba(this.topBarAlpha));this.extendedBar&&this.extendedBar.$bar.css({"background-color":this.color.rgba(this.topBarAlpha)});this.topBarAlpha?(this.topBar&&this.topBar.css({"box-shadow":"","-webkit-box-shadow":""}),this.bottomBar&&this.bottomBar.css({"box-shadow":"","-webkit-box-shadow":""})):
(this.topBar&&this.topBar.css({"box-shadow":"none","-webkit-box-shadow":"none"}),this.bottomBar&&this.bottomBar.css({"box-shadow":"none","-webkit-box-shadow":"none"}));this.resetButtonTitleColor();global.PcTelephoneNumberFrame&&global.PcTelephoneNumberFrame.setColor({color:bookConfig.toolbarColor,textColor:bookConfig.iconFontColor})},setButtonTitle:function(a){if("WeChatShareButton"==a.getClassName())global.WeChatShareImg=new WeChatShare({parent:this.parent,color:"#fff",textColor:bookConfig.toolbarColor,
margin:10,padding:10,arrowHeight:12,arrowWidth:12});else if("TelephoneNumberButton"==a.getClassName())global.PcTelephoneNumberFrame=new PcTelephoneNumberBubble({parent:this.parent,color:this.color,textColor:a.fontColor,margin:4,padding:"15",arrowHeight:8,arrowWidth:8});else{var b=new TextBubble({parent:this.parent,text:a.caption,color:this.color,textColor:a.fontColor,margin:7});a.setTitle(b)}},initBar:virtual_function,initExtendedbar:virtual_function,onResize:virtual_function,initEvents:function(){function a(){this.extendedBar.visible&&
this.extendedBar.hide()}this.topBar&&this.topBar.bind("click",a.bind(this));this.bottomBar&&this.bottomBar.bind("click",a.bind(this))},getHeight:function(){return this.getTopHeight()+this.getBottomHeight()},getTopHeight:function(){var a=this.visible?this.topBar?this.topBar.height()+this.topBar.top():0:0;thumbnail&&(a+=thumbnail.getTopHeight());return a},getLogoHeight:function(){return this.topBar?this.topBar.height():0},getBottomHeight:function(){var a=this.visible?this.bottomBar?this.bottomBar.height()+
this.bottomBar.bottom():0:0;NeatStyle.isNeat()&&(a="fresh"===global.templeteName?55:40);thumbnail&&(a+=thumbnail.getBottomHeight());return a},getWidth:function(){return this.getLeftWidth()+this.getRightWidth()},getLeftWidth:function(){return 0},getRightWidth:function(){return 0},show:function(){if(!this.isMoving&&!this.visible&&this.isRenderToolbar)if(isIE8())this.topBar&&this.topBar.css({display:"block"}),this.bottomBar&&this.bottomBar.css({display:"block"}),this.visible=!0;else{this.isMoving=!0;
if(this.topBar){var a=transformCSS({tran:{x:0,y:0}});animateOnce(this.topBar,a,500)}this.bottomBar&&(a=transformCSS({tran:{x:0,y:0}}),animateOnce(this.bottomBar,a,500));this.visible=!0;BookEvent.trigger("showToolbar",[]);(function(){this.isMoving=!1}).delay(this,500)}},hide:function(a){if(!this.isMoving&&this.visible&&this.isRenderToolbar){var b=this.getTopHeight()+5,c=this.getBottomHeight()+5;isIE8()?(this.topBar&&this.topBar.css({display:"none"}),this.bottomBar&&this.bottomBar.css({display:"none"}),
this.visible=!1):(this.isMoving=!0,this.topBar&&(b=transformCSS({tran:{x:0,y:-b}}),a?animateOnce(this.topBar,b,500):this.topBar.css(b)),this.bottomBar&&(c=transformCSS({tran:{x:0,y:c}}),a?animateOnce(this.bottomBar,c,500):this.bottomBar.css(c)),this.visible=!1,BookEvent.trigger("hideToolbar",[]),function(){this.isMoving=!1}.delay(this,500))}},matchButton:function(a){a=this.buttons.match(a);return 0==a.length?null:a.get(0)},getButton:function(a,b){a=this.buttons.find(a);return 0==a.length?null:1<=
a.length&&b?(a=a.objects.filter(function(c){return c.name==b}),a[0]):a.get(0)},pickButton:function(a){(a=this.getButton(a))&&this.buttons.remove(a);return a},removeButton:function(a){"string"==typeof a&&(a=this.getButton(a));a&&(a.$button.remove(),this.buttons.remove(a))},addButton:function(a){a&&this.buttons.add(a)},changeFullscreenIcon:function(a){var b=this.getButton("fullscreen");b&&(a?b.setAsExitFullScreen():b.setAsFullScreen(),function(){this.onResize()}.delay(this,100))},changeLanguage:function(){this.buttons.each(function(a){a.changeLanguage()})},
buttonsInExtendedBar:function(){var a=new ObjectPool;this.buttons.each(function(b){b.$parent==this.extendedBar.$bar&&a.add(b)}.bind(this));return a},afterButtonClick:function(a){this.extendedBar&&this.extendedBar.visible&&(a!=this.btnMore?isPhone()||isPad()||this.extendedBar.hide():(a=this.buttonsInExtendedBar(),a.each(function(b){b.changeColor()}),a=null))},isRightToLeft:function(){var a=getLanguage("btnSearch","Search");return LanguageTool.isRightToLeft(a)},addCustomButton:function(a){},removeCustomButton:function(a){},
resetPageNumberSize:function(a){if(this.iInputSize&&this.iInputSize!=a){this.iInputSize=a;try{if(this.edtPageNumber){var b=this.edtPageNumber.find("input");b.attr("size",a);b.css("width","auto");var c=b.width();this.edtPageNumber.css("width",c);this.edtPageWidth=c;this.onResize()}}catch(d){}}},selectedButton:function(a){this.selected=a}});
